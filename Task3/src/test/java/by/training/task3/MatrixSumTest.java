...
import by.training.task3.service.matrixOperation.MatrixManager;
...
public class MatrixSumTest {
    ...
    public Object[][] createCorrectData() {
        return
                new Object[][]{
                    ...
                    {new int[]{1,1,1,1,1,1,1,1,1},3,3,new int[]{2,2,2,2,2,2,2,2,2},3,3,new int[]{3,3,3,3,3,3,3,3,3},3,3},
                    {new int[]{-5,-5,-5,-5,-5,-5,-5,-5,-5},3,3,new int[]{-3,-3,-3,-3,-3,-3,-3,-3,-3},3,3,
                            new int[]{-8,-8,-8,-8,-8,-8,-8,-8,-8},3,3},
                };
    }

    @Test(description = "matrix sum test", dataProvider = "input_matrix")
    public void testResult(int[] a,int i1,int j1,int[]b,int i2,int j2, int[]c,int i3,int j3) throws ServiceException {
        ...
        IntegerMatrix actual = matrixSum.result(matrix1,matrix2);
