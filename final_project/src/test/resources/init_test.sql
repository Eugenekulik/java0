...
VALUES (1, 'Аппаратная косметология', 'Аппаратная косметология'),
       ...
       (6, 'Эпиляция', 'Эпиляция'),
       (7, 'для удаления', 'для удаления без связей');
...
VALUES (1, 2, 2, '2021-12-01 09:00:00', 1, 50),
        (2, 2, 1, '2021-12-01 11:00:00', 1, 30),
        (3, 2, 2, '2021-12-01 12:00:00', 1, 50);


insert into test.schedule (id, employee_id, date, appointment_id)
values (1,3,'2021-12-01 10:00:00',1);
INSERT INTO test.schedule(id, employee_id, date)
VALUES (2, 3, '2021-12-01 13:00:00'),
       (3, 3, '2021-12-01 14:00:00');


insert into test.score(id, user_id, value, appointment_id, comment, date)
VALUES (1,2,5,1,'хорошая работа', '2021-12-01 14:00:00');