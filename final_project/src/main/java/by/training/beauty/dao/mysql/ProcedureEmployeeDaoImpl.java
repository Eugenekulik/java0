...
public class ProcedureEmployeeDaoImpl implements ProcedureEmployeeDao {
    private static final Logger LOGGER = LogManager.getLogger(ProcedureEmployeeDaoImpl.class);
    ...
    private static final String SQL_FIND_BY_EMPLOYEE = "SELECT procedure_employee.id, procedure_employee.employee_id, " +
            "procedure_employee.procedure_id, procedure_employee.price, procedure_employee.rating " +
            "FROM procedure_employee WHERE procedure_employee.employee_id = ?;";
    ...
    @Override
    public List<ProcedureEmployee> findByEmployee(User employee) throws DaoException {
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        List<ProcedureEmployee> procedureEmployees = new ArrayList<>();
        try {
